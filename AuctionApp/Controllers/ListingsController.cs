...
namespace AuctionApp.Controllers
{
	public class ListingsController : Controller
	{
		...
		//public async Task<IActionResult> Create([Bind("Id,Description,Price,ImagePath,IsSold,IdentityUserId")] Listing listing)
		//{
		...
		//[HttpPost]
		//[ValidateAntiForgeryToken]
		//public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Price,ImagePath,IsSold,IdentityUserId")] Listing listing)
		//{
		//	if (id != listing.Id)
		//	{
		//		return NotFound();
